...
<h1 class="text-2xl w-full text-center m-3 font-bold">{ricky.investigator_type} Investigator</h1>
<div
    class="flex flex-wrap place-content-center border-2 rounded-3xl mx-5 p-3 drop-shadow-sm font-mono text-sm"
>
    <section id="details-section" class="grid grid-cols-6 gap-2 w-4/5">
    ...
    <section id="characteristics-section" class="grid grid-cols-6 gap-1 w-4/5">
    ...
    <section id="toggleables-section" class="grid grid-cols-5 w-3/4 mt-3">
    ...
    <section id="skill-section" class="grid grid-cols-6 w-4/5 gap-1">
